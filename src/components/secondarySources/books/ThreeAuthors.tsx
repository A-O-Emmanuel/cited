    ...
    return(
        <>
            ...
            <form action="">
                ...
                <label htmlFor="">2nd Author's First Name</label> <br />
                <input type="text" /> <br />

                <label htmlFor="">2nd Author's Surname</label> <br />
                <input type="text" /><br />

                <label htmlFor="">3rd Author's First Name</label> <br />
                <input type="text" /> <br />

                <label htmlFor="">3rd Author's Surname</label> <br />
                <input type="text" /> <br />
